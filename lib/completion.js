...
Completion.prototype = {
  ...
  completeInfo: function (info, cb) {
    ...
    // TODO: This is a logical fallacy. We can only have (1) if it is an *option*
    // TODO: -B might be a better example for `git checkout`
    // (1) a function that will reply with auto-complete options
      // TODO: Complete example
      // `git checkout -b wo|rld` -> ['git', checkout', '-b', 'wo'] + ['rld']
    // (2) recurse until second to last word in the left half of the command
    ...
    // Otherwise, if we have less than 2 remaining left words, return early
    } else if (info.words.remainingLeft.length < 2) {
      ...
      // Otherwise, attempt to understand what to do
        ...
        if (typeof secondToLastNode === 'object') {
