...
Completion.prototype = {
  ...
  completeInfo: function (info, cb) {
    ...
    function resolveCompletions(node, remainingLeftWords, callback) {
      ...
      // Otherwise, attempt to keep on recursing
        ...
        resolveCompletions(childNode, remainingLeftWords, callback);
      }
    }
    resolveCompletions(this.node, info.words.partialLeft, cb);
  }
};
